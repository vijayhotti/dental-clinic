...
# Only initialize the database if DATABASE_URL is not set (i.e., using SQLite)
if [ -z "$DATABASE_URL" ]; then
    ...
    log_message "DATABASE_URL is set. Skipping DB initialization (using RDS/PostgreSQL)."
fi
